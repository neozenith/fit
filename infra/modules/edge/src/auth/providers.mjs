 ...
 *
 * PASTE THE PATH DATA VERBATIM. Never tidy it — not the repeated polygon
 * points, not the `h0s0,0,0,0` no-ops, not the mixed comma and space
 * separators. "Simplifying" `m7.853,1.507L.353,9.967` to `m7.853 1.507.353
 * 8.46` turns an ABSOLUTE lineto into a relative one and silently deforms the
 * mark; it shipped that way once, and nothing but a screenshot caught it.
 */
const ICONS = {
  google:
  ...
  entra:
    ...
    `<path d="m7.853,1.507L.353,9.967c-.579.654-.428,1.642.323,2.111,0,0,2.776,1.735,3.126,1.954.388.242,1.033.511,1.715.511.621,0,1.198-.18,1.676-.487,0,0,.001,0,.002-.001l1.805-1.128-4.364-2.728,4.365-4.924V1s0,0,0,0c-.424,0-.847.169-1.147.507Z" fill="#66ddff"/>` +
    ...
    `<polygon points="13.365 10.199 13.365 10.199 13.365 10.199 9.001 5.276 9.001 12.926 13.365 10.199" fill="#96bcc2"/></svg>`,
};
