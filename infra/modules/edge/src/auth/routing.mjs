...
/**
 * The word "fit" set in Fraunces, as OUTLINES.
 *
 * Generated by `tools/icon/edge_wordmark.py` (wght 400, SOFT 50, WONK 1,
 * opsz 144 — the settled lockup from build_icons.py). Regenerate rather than
 * hand-edit.
 *
 * Outlines rather than a webfont for the same reason everything else here is
 * inline: `@font-face { src: url("/fonts/Fraunces.ttf") }` is a request to this
 * distribution, which arrives with no session and is redirected back to this
 * page. The heading would silently fall back to Georgia — the exact bug the
 * SPA's own tokens.css comment records having shipped once already.
 *
 * At 2KB the outlines also beat the 300KB variable font they came from.
 */
const WORDMARK =
  '<svg viewBox="0 0 49.4 49.0" width="49.4" height="49.0" role="img" aria-label="fit"><g fill="#e9b26a" transform="translate(0 42.16) scale(0.03143 -0.03143)"><path transform="translate(0 0)" d="M346 110Q346 89 354 77Q362 66 383 63L483 52Q497 51 504 44Q511 36 511 25Q511 0 482 0H75Q62 0 55 6Q47 13 47 24Q47 35 54 42Q60 49 72 52L131 62Q150 67 158 78Q167 89 167 108V754Q167 772 160 781Q153 790 133 796L54 814Q37 820 30 828Q24 835 24 846Q24 856 31 862Q38 868 50 868H200L169 840V867Q169 904 155 939Q140 973 122 1010Q103 1047 89 1090Q75 1132 75 1184Q75 1295 146 1363Q217 1431 340 1431Q415 1431 465 1406Q516 1381 542 1339Q568 1297 568 1248Q568 1199 544 1174Q521 1149 485 1149Q446 1149 422 1175Q398 1201 398 1247V1300Q398 1341 378 1363Q358 1384 316 1384Q257 1384 223 1346Q190 1307 190 1239Q190 1197 205 1157Q220 1117 242 1080Q264 1043 287 1007Q309 971 324 937Q339 902 339 867V838L318 868H510Q525 868 533 863Q541 857 541 846Q541 829 526 818Q512 808 481 808H346Z"/><path transform="translate(546 0)" d="M331 850V110Q331 87 338 76Q346 66 363 61L413 52Q424 48 429 41Q434 34 434 24Q434 13 427 7Q420 0 406 0H74Q61 0 53 7Q46 13 46 24Q46 34 51 40Q56 47 67 51L118 61Q136 66 143 76Q150 87 150 109V726Q150 743 145 751Q140 758 127 760L60 762Q49 765 44 771Q39 777 39 785Q39 795 46 802Q52 809 67 814L252 871Q272 878 282 880Q293 882 302 882Q316 882 323 873Q331 864 331 850ZM231 1047Q177 1047 144 1081Q110 1115 110 1167Q110 1220 144 1254Q178 1288 231 1288Q285 1288 319 1254Q353 1220 353 1167Q353 1115 319 1081Q285 1047 231 1047Z"/><path transform="translate(1004 0)" d="M105 801 34 813Q20 817 15 825Q11 833 11 843Q11 854 19 861Q27 868 40 868H113Q124 868 132 875Q140 881 148 897L240 1045Q249 1060 260 1067Q270 1075 282 1075Q294 1075 301 1067Q309 1059 309 1042V220Q309 153 336 119Q364 85 412 85Q437 85 455 93Q473 101 487 114Q501 126 512 140Q523 155 533 168Q540 170 545 165Q550 160 549 146Q541 98 514 61Q487 24 445 3Q402 -18 345 -18Q244 -18 188 34Q131 87 131 196V759Q131 778 127 787Q122 797 105 801ZM237 808 239 868H520Q535 868 543 863Q550 857 550 845Q550 829 536 818Q521 808 490 808Z"/></g></svg>';
...
export const chooserPage = (choices) =>
  ...
  // The heading is the outlined wordmark, so `h1` carries no font of its own.
  // The text stays in the SVG's aria-label, which is what a screen reader
  // announces — an image of a word is still the word.
  `h1{margin:1.25rem 0 .5rem;line-height:0}` +
  ...
  `<main>${MARK}<h1>${WORDMARK}</h1><p>Sign in to continue</p>` +
